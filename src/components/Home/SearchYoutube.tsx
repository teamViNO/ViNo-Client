...
import { SearchForm, SearchInput, SearchButton, SearchContainer } from '@/styles/HomepageStyle';
    ...
    <SearchContainer>
      <SearchForm onSubmit={handleSubmit}>
        <div className='search-text'>
          ...
          <h4 className='search-subtitle'>영상에서 글로 변환하고 싶은 YouTube 영상의 링크를 붙여넣어주세요</h4>
        </div>
