...
const SummaryScriptBox = () => {
  ...
  // 추후 API 연결하면 변경
  const [scriptList] = useState([
    {
      id: 1,
      title: '생성형 AI 검색과 광고',
      start_time: '00:44',
      end_time: '01:56',
      content: `올해 IT업계의 가장 큰 화제는 단연코 생성형 AI라고 할 수 있겠습니다. 2022년 11월, OpenAI가 출시한 ChatGPT는 멀게만 느껴졌던 AI 기술을 우리의 실생활에 밀접한 서비스로 바꾸었죠. 그리고 이제는 디지털 광고 영역에서도 본격적으로 활용되고 있어요.
    ...
    },
    {
      ...
      start_time: '00:44',
      end_time: '01:56',
      content: `올해에 이어 내년에도 숏폼은 중요한 트렌드 키워드였습니다. 유튜브 쇼츠나 메타의 릴스, 틱톡 등 주요 숏폼 플랫폼들은 크리에이터가 콘텐츠를 쉽게 제작할 수 있고 돈도 벌 수 있는 방안을 마련하고 있는데요. 그만큼 숏폼 콘텐츠가 굉장한 성장률을 보이고 있기 때문이죠. 지난 2분기 메타의 릴스 하루 시청수는 2천억 건 이상으로 집계돼 전년 대비 42.8% 증가했고요. 연간 매출 전망치도 100억 달러에 이를 것으로 보여요.
    ...
    },
    {
      ...
      start_time: '00:44',
      end_time: '01:56',
      content: `<mark>asdf</mark>올해 IT업계의 가장 큰 화제는 단연코 생성형 AI라고 할 수 있겠습니다. 2022년 11월, OpenAI가 출시한 ChatGPT는 멀게만 느껴졌던 AI 기술을 우리의 실생활에 밀접한 서비스로 바꾸었죠. 그리고 이제는 디지털 광고 영역에서도 본격적으로 활용되고 있어요.
